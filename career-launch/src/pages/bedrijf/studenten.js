...
export async function renderStudenten(rootElement, studentData = {}) {
  let huidigeZoek = '';
  let huidigeLocatie = '';
  let huidigeDomein = '';
  ...
  try {
    ...
    if (!Array.isArray(students)) {
      ...
      studenten = students.map((company) => ({
        naam: company.naam,
      ...
      <div class="student-profile-main">
        ...
        <div class="student-profile-content">
          <div class="student-profile-form-container">
            <h1 class="student-profile-title">Studenten</h1>
      ...
      import('../../router.js').then((module) => {
        ...
        switch (route) {
          ...
          case 'requests':
            ...
            break;
          case 'studenten':
            Router.navigate('/student/studenten');
            break;
          case 'qr':
  ...
  if (burger && dropdown) {
    ...
    document.getElementById('nav-settings').addEventListener('click', () => {
      dropdown.classList.remove('open');
      showStudentSettingsPopup(() => renderStudenten(rootElement, studentData));
    });
